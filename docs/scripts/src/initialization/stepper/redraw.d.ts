 ...
 */
declare const animatePosition: (obj: Object3D, to: Vector3, delay?: number | undefined) => Tween<Vector3>;
/**
 ...
 * @return {Tween} an Instance of Tween.
 */
declare const animateRotation: (from: Object3D, to: Quaternion, delay?: number | undefined) => Tween<Quaternion>;
/**
