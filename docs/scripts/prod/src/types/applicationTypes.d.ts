 ...
 * @typedef {ObjectID}
 */
export declare type ObjectID = string | number;
/**
 ...
 * @typedef {Objects3D}
 */
export declare type Objects3D = Map<ObjectID, Object3D>;
/**
 ...
 */
export declare type ComputedPostions = Map<ObjectID, RuntimePose>;
/**
 ...
 * @typedef {RuntimePose}
 */
export declare type RuntimePose = {
    /**
 ...
 * @typedef {Color}
 */
export declare type Color = ThreeColor | string;
/**
 ...
 * @typedef {Animations}
 */
export declare type Animations = Map<string, AnimationDef>;
/**
 ...
 */
export declare type AnimationDef = (obj: Object3D) => Tween<Record<string, unknown>> | void;
/**
 * UUID of instance.
 * @author Matej Hakoš
 *
 ...
 */
export declare type CallbackFunction = (obj: Object3D, ev: Event) => void;
/**
 ...
 */
export declare type getObjectFunction = (key: ObjectID) => Object3D | undefined;
/**
 ...
 */
export declare type CameraCallback = (cmaera: Camera) => void;
/**
 ...
 */
export declare type elementSizing = {
    width: number;
    height: number;
};
/**
